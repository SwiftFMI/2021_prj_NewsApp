...
class SystemAssets {
    ...
    static let bubbleLeftRight = UIImage(systemName: "bubble.left.and.bubble.right")
    ...
    static let arrowShapeUpRightCircle = UIImage(systemName: "arrowshape.turn.up.right.circle")
    ...
    static let photoCircleFill = UIImage(systemName: "photo.circle.fill")
